 ...
 */
const environment = {
  attributes:{"sheet_version":"0","FE2_tab":"nav-tabs-fe2--settings","character_name":"","species":"","undefined_goal":"11","undefined_action":"","undefined":"0","strength":"","strength_max":"","strength_limit":"","strength_mod":"","strength_trait":"","template_start":"@{whisper}&{template:FE2} {{character_name=@{character_name}}} {{character_id=@{character_id}}}"},
  triggers: [],
  translation,
  otherCharacters: {
...
registerFuncs({ kTabOnOpen },{type:['opener']});
    ...
    const actionAttributes = ["undefined_action"];/**
